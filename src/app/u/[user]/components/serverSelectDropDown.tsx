...
export default function ServerSelectDropDown({ servers, currentServer }: { servers: PlayerData[], currentServer: string}) {
    ...
    return (
        <>
            ...
            <div id="dropdown" className={`z-10 ${serverPickDropDown ? "absolute" : "hidden"} bottom-0 translate-y-[110%] translate-x-0 sm:translate-x-12 bg-white divide-y divide-gray-100 rounded-lg shadow w-full sm:w-44 dark:bg-gray-700`}>
