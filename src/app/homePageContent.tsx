    ...
    return (
        <div className="h-auto flex flex-col pt-[3vh]">
            ...
            <div className="font-Protest text-white w-full flex flex-col text-center">
                <div className="bg-forestbot-banner bg-cover w-[33rem] h-[33rem] mx-auto bg-center bg-no-repeat"></div>
                ...
                <div className="flex flex-row gap-5 items-center mx-auto p-3">
